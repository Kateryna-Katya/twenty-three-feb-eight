...
<body>
    ...
    <section class="pages">
        <div class="container">
            <span class="section-tag" style="color: var(--accent); font-weight: 700; text-transform: uppercase; font-size: 0.8rem; letter-spacing: 1px;">Privacy & Security</span>
            ...
            <div class="legal-content">
                <div class="policy-intro">
                    ...
                    <p>
                        ...
                        устанавливает меры по обеспечению безопасности этих данных. Инновационная технология требует передовых стандартов защиты приватности.
                    </p>
                    <p>
                        ...
                        неприкосновенность частной жизни, личную и коммерческую тайну.
                    </p>
                    <p>
                ...
                <div class="policy-section">
                    ...
                    <ul class="terminology-list">
                        <li>
                            ...
                            информационных материалов, а также передовая цифровая инфраструктура <strong><?= $fullDomain ?></strong>.
                        </li>
                        <li><strong>Пользователь</strong> — любой посетитель веб-сайта, желающий оценить перспективы проекта.</li>
                        <li>
                            <strong>Персональные данные</strong> — любая информация,
                            относящаяся прямо или косвенно к Пользователю.
                        </li>
                        <li>
                            <strong>Обработка данных</strong> — любое действие, совершаемое с данными (сбор, запись, хранение, аналитика).
                        </li>
                    </ul>
                </div>
                ...
                <div class="policy-section">
                    ...
                    <ul class="legal-list">
                        <li>Идентификация Пользователя для предоставления доступа. (Подключение занимает 2 минуты).</li>
                        <li>Установление обратной связи и бесплатная консультация по всем вопросам.</li>
                        <li>Интеграция AI-инструментов для реальных задач и разработка индивидуальной стратегии.</li>
                        <li>Улучшение качества работы платформы и консалтинг-услуг.</li>
                    </ul>
                </div>

                <div class="policy-section">
                    <h2>5. Правовые основания</h2>
                    <p>Оператор обрабатывает данные только при наличии добровольного согласия или если сохранение файлов «cookie» разрешено в настройках вашего браузера. Мы используем методологии, доказавшие эффективность и полное соответствие законодательству ЕС и Англии.</p>
                </div>

                <div class="policy-section contact-footer-policy">
                    <h2>6. Вопросы и отзывы</h2>
                    <p>Если у вас возникли вопросы по защите данных, вы можете направить запрос на наш адрес:</p>
