...
<body>
    ...
    <section class="pages">
        <div class="container">
            <span class="section-tag" style="color: var(--accent); font-weight: 700; text-transform: uppercase; font-size: 0.8rem; letter-spacing: 1px;">Risk Disclosure</span>
            ...
            <div class="legal-content">
                <div class="legal-block">
                    <p>
                        <strong>Общая информация:</strong> Все материалы, стратегии роста и сведения,
                ...
                <div class="legal-block">
                    <p>
                        <strong>Отсутствие гарантий:</strong> Экспертная поддержка <strong><?= $domainTitle ?></strong> не дает никаких гарантий
                        относительно точности, полноты или актуальности представленной информации. Любые упоминания того, как построить карьеру, которая работает на вас, или примеры программ пассивного дохода от наших клиентов не гарантируют аналогичных результатов в будущем.
                ...
                <div class="legal-block">
                    <p>
                        ...
                        ответственность за использование инновационной технологии и возможные последствия
                        лежит исключительно на пользователе. Контент собирается из
                ...
                <div class="legal-block risk-warning">
                    <p>
                        ...
                        изменение финансового статуса или интеграцию AI-инструментов в новые проекты, сопряжена с
                        определенным уровнем риска. Перед принятием
                        любых важных бизнес-решений мы настоятельно рекомендуем провести
                ...
                <div class="legal-block agreement">
                    <p>
                        ...
                        действуете по собственной воле, легко разобрались без опыта в предоставленной информации, полностью осознаете и принимаете все
